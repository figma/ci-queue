...
export declare class BaseRunner {
    isMaster: boolean;
    ...
    } & import("redis").RedisModules, import("redis").RedisFunctions, {
        acknowledge: {
            NUMBER_OF_KEYS: number;
            SCRIPT: string;
            transformArguments(this: void, setKey: string, processedKey: string, ownersKey: string, testName: string): string[];
        } & import("@redis/client/dist/lib/lua-script").SHA1;
        requeue: {
            NUMBER_OF_KEYS: number;
            SCRIPT: string;
            transformArguments(this: void, processedKey: string, requeuesCountKey: string, queueKey: string, setKey: string, workerQueueKey: string, ownersKey: string, maxRequeues: number, globalMaxRequeues: number, testName: string, offset: number): string[];
        } & import("@redis/client/dist/lib/lua-script").SHA1;
        release: {
            NUMBER_OF_KEYS: number;
            SCRIPT: string;
            transformArguments(this: void, setKey: string, workerQueueKey: string, ownersKey: string): string[];
        } & import("@redis/client/dist/lib/lua-script").SHA1;
        reserve: {
            NUMBER_OF_KEYS: number;
            SCRIPT: string;
